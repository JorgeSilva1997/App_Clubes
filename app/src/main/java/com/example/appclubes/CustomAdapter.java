...
public class CustomAdapter extends BaseAdapter {
    ...
    public CustomAdapter(Context ctx, List<ListViewItemDTO> listViewItemDtoList) {
        this.ctx = ctx;
    ...
    public View getView(int itemIndex, View convertView, ViewGroup viewGroup) {
        ...
        {
            convertView = View.inflate(ctx, R.layout.lista_row, null);

            CheckBox listItemCheckbox = (CheckBox) convertView.findViewById(R.id.checkbox);

            TextView listItemText = (TextView) convertView.findViewById(R.id.NomeAtleta);
